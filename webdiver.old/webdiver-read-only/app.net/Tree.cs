...
//		private class EnumeratorBase : IEnumerable, IEnumerator
		...
		private class DefaultEnumerator : EnumeratorBase
		{
			...
			public override bool MoveNext()
			{
				...
				if ( _Current == null ) { _AfterLast = true; return false; }
...
// ICollection
		...
		public bool IsSynchronized { get { return false; } } // Not thread safe
		
		public object SyncRoot { get { return this; } } // Not sure about this!
